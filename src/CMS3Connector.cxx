...
ObjUtil::Lepton getMuon(int idx)
{
  ...
  lepton.relIso005EAstudy = muRelIsoCustomCone(idx, 0.05, false, 0.5, false, true, -1, 1);
  lepton.relIso010EAstudy = muRelIsoCustomCone(idx, 0.10, false, 0.5, false, true, -1, 1);
  lepton.relIso015EAstudy = muRelIsoCustomCone(idx, 0.15, false, 0.5, false, true, -1, 1);
  lepton.relIso020EAstudy = muRelIsoCustomCone(idx, 0.20, false, 0.5, false, true, -1, 1);
  lepton.relIso025EAstudy = muRelIsoCustomCone(idx, 0.25, false, 0.5, false, true, -1, 1);
  lepton.relIso030EAstudy = muRelIsoCustomCone(idx, 0.30, false, 0.5, false, true, -1, 1);
  lepton.relIso035EAstudy = muRelIsoCustomCone(idx, 0.35, false, 0.5, false, true, -1, 1);
  lepton.relIso045EAstudy = muRelIsoCustomCone(idx, 0.45, false, 0.5, false, true, -1, 1);
  lepton.relIso050EAstudy = muRelIsoCustomCone(idx, 0.50, false, 0.5, false, true, -1, 1);
