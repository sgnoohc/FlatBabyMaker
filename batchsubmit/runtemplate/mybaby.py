...
if not os.path.isfile(package):
    raise Exception("Woah! Did you run make_job_inputs.sh? I don't see the %s file in %s" % (package, inputs_path))
#elif ((os.path.getmtime(package) < os.path.getmtime("$DITTOPATH/ditto_")) or (os.path.getmtime(package) < os.path.getmtime("../skim_macro.C"))):
